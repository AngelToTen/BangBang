function jugar() {
	...
	var sfxStart = new Audio('sfx/start.wav');
	sfxStart.play();
}
...
function siguientePersonaje() {
	...
	var sfxclic = new Audio('sfx/jump.wav');
	sfxclic.play();
}
...
function sonidoGanador() {
	var sfxWinner = new Audio('sfx/win.wav');
	sfxWinner.play();
}
...
function disparo1() {
	...
	primerDisparo = 1;
	timeoutEmpate = setTimeout(ejecutarDisparo1, 80); 
}
...
function disparo2() {
	...
	primerDisparo = 2;
	timeoutEmpate = setTimeout(ejecutarDisparo2, 80); 
}
